    ...
    return (
        <div className="login border rounded p-3 bg-light shadow">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button className="btn btn-success text-white w-100 mb-1 rounded-pill" onClick={handleGoogleSignIn}><FontAwesomeIcon className="text-white mr-3" icon={faGoogle} />Continue with Google</button>
            </form>
